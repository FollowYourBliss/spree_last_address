module Spree
  ...
  private
    ...
    def before_address
      ...
      preferred_bill_address, preferred_ship_address = current_spree_user.bill_address, current_spree_user.ship_address if current_spree_user.respond_to?(:bill_address) && current_spree_user.respond_to?(:ship_address)
